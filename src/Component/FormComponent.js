  ...
  return (
    <main>
      ...
      <form className="inputForm">                
        ...
        <label className="serviceName-title">Fill in the first or both fields. If you put key words, we use just it to define the Public Service contact</label>
        <br />
        <input             
          className="text"
      ...
      <div className="entered-info">
        ...
        <p>Your Public Service (or name or key words): {props.serviceName}</p>
        <p>Your Public Service (or name or key words): {props.serviceKeyWords}</p>
